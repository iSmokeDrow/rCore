...
namespace rCore.Structures
{
    public class Row : IEnumerable
    {
        ...
        public object this[CellType key]
        {
            get { return Cells.Find(f => f.Info.Type == Enum.GetName(typeof(CellType), key)).Value; }
            set { Cells.Find(f => f.Info.Type == Enum.GetName(typeof(CellType), key)).Value = value; }
        }
